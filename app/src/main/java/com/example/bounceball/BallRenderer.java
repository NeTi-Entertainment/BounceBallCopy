...
public class BallRenderer {
    ...
    public static void setColor(int color) {
        sBallPaint.setColor(color);
    }
    private static String sCurrentSkin   = "";
    private static float  sBallRotation  = 0f;
    private static float  sBallVelocityX = 0f;
    private static float  sBallVelocityY = 0f;

    public static void setAnimState(String skinId, float rotation, float vx, float vy) {
        sCurrentSkin   = skinId != null ? skinId : "";
        sBallRotation  = rotation;
        sBallVelocityX = vx;
        sBallVelocityY = vy;
    }

    private static final Paint soccerBasePaint = new Paint(Paint.ANTI_ALIAS_FLAG);
    private static final Paint soccerPentPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
    private static final Paint soccerShadowPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
    private static final Paint soccerStrokePaint = new Paint(Paint.ANTI_ALIAS_FLAG);
    private static final Path soccerClipPath = new Path();
    private static final Path soccerPentPath = new Path();
    private static final Matrix soccerBaseMatrix = new Matrix();
    private static final Matrix soccerShadowMatrix = new Matrix();
    private static final RadialGradient soccerBaseGradient = new RadialGradient(
            0, 0, 1, new int[]{0xFFFFFFFF, 0xFFD0D0D0, 0xFF909090},
            new float[]{0f, 0.5f, 1f}, Shader.TileMode.CLAMP);
    private static final RadialGradient soccerShadowGradient = new RadialGradient(
            0, 0, 1, new int[]{0x00000000, 0x66000000},
            new float[]{0f, 1f}, Shader.TileMode.CLAMP);

    private static final Paint lavaBodyPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
    private static final Paint lavaCrustPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
    private static final Paint lavaBubblePaint = new Paint(Paint.ANTI_ALIAS_FLAG);
    private static final Paint lavaBorderPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
    private static final BlurMaskFilter lavaCrustBlur  =
            new BlurMaskFilter(8f, BlurMaskFilter.Blur.NORMAL);
    private static final BlurMaskFilter lavaBorderBlur =
            new BlurMaskFilter(6f, BlurMaskFilter.Blur.NORMAL);
    private static final Path lavaEdgePath = new Path();
    private static final Path[] lavaRockPaths = new Path[]{new Path(), new Path(), new Path(), new Path(), new Path(), new Path()};
    private static final Matrix lavaBodyMatrix = new Matrix();
    private static final Matrix[] lavaBubbleMatrices = new Matrix[]{new Matrix(), new Matrix(), new Matrix(), new Matrix(), new Matrix()};
    private static final RadialGradient lavaBodyGradient = new RadialGradient(
            0, 0, 1, new int[]{0xFFFF6600, 0xFFDD2200, 0xFF880000},
            new float[]{0f, 0.5f, 1f}, Shader.TileMode.CLAMP);
    private static final RadialGradient[] lavaBubbleGradients = new RadialGradient[]{
            ...
            new RadialGradient(0,0,1,new int[]{0xFFFF8800,0xFFDD2200},new float[]{0f,1f},Shader.TileMode.CLAMP),
            new RadialGradient(0,0,1,new int[]{0xFFFFAA00,0xFFFF4400},new float[]{0f,1f},Shader.TileMode.CLAMP),
            new RadialGradient(0,0,1,new int[]{0xFFFFCC00,0xFFFF6600},new float[]{0f,1f},Shader.TileMode.CLAMP)
    };
    ...
    public static void drawTennisBall(Canvas canvas, float cx, float cy, float r) {
        sBallPaint.setStyle(Paint.Style.FILL);
        canvas.drawCircle(cx, cy, r, sBallPaint);
    ...
    public static void drawBowlingBall(Canvas canvas, float cx, float cy, float r) {
        // Base violet foncé
        sBallPaint.setStyle(Paint.Style.FILL);
        canvas.drawCircle(cx, cy, r, sBallPaint);
    ...
    public static void drawSoccerBall(Canvas canvas, float cx, float cy, float r) {
    ...
    public static void drawPetanque(Canvas canvas, float cx, float cy, float r) {
    ...
    public static void drawGolf(Canvas canvas, float cx, float cy, float r) {
        Paint base = new Paint(Paint.ANTI_ALIAS_FLAG);
        base.setStyle(Paint.Style.FILL);
    ...
    public static void drawCatEye(Canvas canvas, float cx, float cy, float r) {
    ...
    public static void drawBeachBall(Canvas canvas, float cx, float cy, float r) {
    ...
    public static void drawVolleyball(Canvas canvas, float cx, float cy, float r) {
        Paint base = new Paint(Paint.ANTI_ALIAS_FLAG);
        base.setStyle(Paint.Style.FILL);
        base.setShader(new RadialGradient(
    ...
    public static void drawBaseball(Canvas canvas, float cx, float cy, float r) {
        sBallPaint.setStyle(Paint.Style.FILL);
        canvas.drawCircle(cx, cy, r, sBallPaint);
    ...
    public static void draw8Ball(Canvas canvas, float cx, float cy, float r) {
    ...
    public static void drawMetalBall(Canvas canvas, float cx, float cy, float r) {
        int[] colors;
        switch (sCurrentSkin) {
            case "ball_gold":
                colors = new int[]{
    ...
    public static void drawBismuth(Canvas canvas, float cx, float cy, float r) {
        // Base argentée
        Paint base = new Paint(Paint.ANTI_ALIAS_FLAG);
        base.setStyle(Paint.Style.FILL);
        base.setShader(new LinearGradient(
    ...
    public static void drawDamascus(Canvas canvas, float cx, float cy, float r) {
        // Base acier sombre
        Paint base = new Paint(Paint.ANTI_ALIAS_FLAG);
        base.setStyle(Paint.Style.FILL);
        base.setShader(new LinearGradient(
    ...
    public static void drawMeteorite(Canvas canvas, float cx, float cy, float r) {
    ...
    public static void drawComet(Canvas canvas, float cx, float cy, float r) {
    ...
    public static void drawMercury(Canvas canvas, float cx, float cy, float r) {
        // Base gris-brun
        sBallPaint.setStyle(Paint.Style.FILL);
        canvas.drawCircle(cx, cy, r, sBallPaint);
    ...
    public static void drawVenus(Canvas canvas, float cx, float cy, float r) {
...
// {offset_y, amplitude, ctrl_dx1, ctrl_dx2, épaisseur, alpha, couleur_hex}
    ...
    public static void drawEarth(Canvas canvas, float cx, float cy, float r) {
    ...
    public static void drawMoon(Canvas canvas, float cx, float cy, float r) {
        Paint base = new Paint(Paint.ANTI_ALIAS_FLAG);
        base.setStyle(Paint.Style.FILL);
        base.setShader(new RadialGradient(
                cx - r * 0.2f, cy - r * 0.2f, r * 1.1f,
    ...
    public static void drawMars(Canvas canvas, float cx, float cy, float r) {
    ...
    public static void drawJupiter(Canvas canvas, float cx, float cy, float r) {
        // Base beige chaud
        Paint base = new Paint(Paint.ANTI_ALIAS_FLAG);
        base.setStyle(Paint.Style.FILL);
        base.setShader(new RadialGradient(
    ...
    public static void drawSaturn(Canvas canvas, float cx, float cy, float r) {
    ...
    public static void drawUranus(Canvas canvas, float cx, float cy, float r) {
...
// Calotte polaire : très discrète
    ...
    public static void drawNeptune(Canvas canvas, float cx, float cy, float r) {
        Paint base = new Paint(Paint.ANTI_ALIAS_FLAG);
        base.setStyle(Paint.Style.FILL);
        base.setShader(new RadialGradient(
                cx - r * 0.25f, cy - r * 0.25f, r * 1.1f,
    ...
    public static void drawPluto(Canvas canvas, float cx, float cy, float r) {
        Paint base = new Paint(Paint.ANTI_ALIAS_FLAG);
        base.setStyle(Paint.Style.FILL);
        base.setShader(new RadialGradient(
                cx - r * 0.2f, cy - r * 0.2f, r * 1.1f,
    ...
    public static void drawStar(Canvas canvas, float cx, float cy, float r, int[] p) {
    ...
    public static void drawBlackHole(Canvas canvas, float cx, float cy, float r) {
    ...
    public static void drawPulsar(Canvas canvas, float cx, float cy, float r) {
    ...
    public static void drawFireBall(Canvas canvas, float cx, float cy, float r) {
        ...
        float windX = -sBallVelocityX;
        float windY = -sBallVelocityY - convection;
    ...
    public static void drawWaterBall(Canvas canvas, float cx, float cy, float r) {
        long t = System.currentTimeMillis();
        ...
        float speed = (float) Math.hypot(sBallVelocityX, sBallVelocityY);
        float stretch = Math.min(1.2f, speed / 30f);
        float moveAngle = (float) Math.atan2(sBallVelocityY, sBallVelocityX);
        ...
        Path waterEdge = buildWaterEdge(cx, cy, r, p1, p2, p3, sBallVelocityX, sBallVelocityY);
    ...
    private static Path buildWaterEdge(float cx, float cy, float r, float p1, float p2, float p3, float vx, float vy) {
        Path path = new Path();
        int pts = 120;
    ...
    public static void drawIceBall(Canvas canvas, float cx, float cy, float r) {
        long t = System.currentTimeMillis();
        ...
        canvas.save();
        canvas.rotate(-sBallRotation, cx, cy); // Contre-rotation pour garder l'étoile droite
    ...
    private static Path buildIceEdge(float cx, float cy, float r) {
        Path path = new Path();
        float[] angles = {
    ...
    public static void drawElemEarthBall(Canvas canvas, float cx, float cy, float r) {
        long t = System.currentTimeMillis();
    ...
    public static void drawDarknessBall(Canvas canvas, float cx, float cy, float r) {
        long t = System.currentTimeMillis();
    ...
    public static void drawLightBall(Canvas canvas, float cx, float cy, float r) {
        long t = System.currentTimeMillis();
    ...
    public static void drawAirBall(Canvas canvas, float cx, float cy, float r) {
        long t = System.currentTimeMillis();
    ...
    public static void drawLightningBall(Canvas canvas, float cx, float cy, float r) {
        long t = System.currentTimeMillis();
        long frame = t / 40;
    ...
    public static void drawPlasmaBall(Canvas canvas, float cx, float cy, float r) {
        long t = System.currentTimeMillis();
    ...
    public static void drawLavaBall(Canvas canvas, float cx, float cy, float r) {
        long t = System.currentTimeMillis();
    ...
    private static Path soccerPentagon(float cx, float cy, float r, float startAngle) {
        Path path = new Path();
        for (int i = 0; i < 5; i++) {
    ...
    private static Path soccerPentagonDistorted(float cx, float cy, float r, float startAngle,
    ...
    private static void fillPentagonPath(Path path, float cx, float cy, float r, float startAngle) {
        path.reset();
        for (int i = 0; i < 5; i++) {
            double a = startAngle + Math.PI * 2 * i / 5;
            float x = cx + (float) Math.cos(a) * r;
    ...
    private static Path regularPentagon(float cx, float cy, float r, float startAngle) {
        Path path = new Path();
        for (int i = 0; i < 5; i++) {
            double a = startAngle + Math.PI * 2 * i / 5;
            float x = cx + (float) Math.cos(a) * r;
    ...
    public static void draw(Canvas canvas, float cx, float cy, float r, String skinId) {
        switch (skinId != null ? skinId : "") {
            ...
            case "ball_rosegold": case "ball_platinum": drawMetalBall(canvas, cx, cy, r); break;
